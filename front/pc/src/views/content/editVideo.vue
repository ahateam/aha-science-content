	...
	<div>
		...
		<el-row style="padding: 20px">
			...
			<el-col :span="20">
				...
				<input @change="getMechData2($event)" type="file" class="upload"  />
				</el-input>
			</el-col>
		</el-row>
		...
		<el-row style="margin-top: 20px">
			<el-button type="primary" @click="addContent" style="margin: 0 auto;display: block;padding: 15px 50px">提交修改
			</el-button>
		</el-row>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.text = JSON.parse(info.data).text
			this.imgSrc = JSON.parse(info.data).imgSrc
			this.src = JSON.parse(info.data).url
